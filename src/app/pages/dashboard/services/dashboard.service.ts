...
export class DashboardService {
  public loadFranchiseTableData(): Observable<FranchiseTableData[]> {
    return of([
      {name: "Franquia Toto", email: "email@email.com", phone: "54 9999 9999", id:"1"},
      {name: "Franquia Africa", email: "email2@email.com", phone: "54 9999 9239", id:"2"}
    ]);
  } 

  public loadFranchiseeTableData(): Observable<FranchiseeTableData[]> {
    return of([
      {name: "Carry On", email: "email@email.com", phone: "54 9999 9999", id:"1"},
      {name: "My Wayward Son", email: "email2@email.com", phone: "54 9999 9239", id:"2"}
    ]);
  }
